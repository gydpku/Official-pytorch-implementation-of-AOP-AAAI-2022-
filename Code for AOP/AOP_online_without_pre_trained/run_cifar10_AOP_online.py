...
appr = approach.Appr(model=net, nepochs=args.nepochs,sbatch=10, lr=args.lr, args=args)
...
for t, ncla in taskcla:
    ...
    # Train
    appr.train(t, xtrain, ytrain, xvalid, yvalid, data,num_class=num_class,test_id=5,lr=0.04-0.003*t)
    print('-'*100)
    '''
    # Test
    for u in range(t+1):
