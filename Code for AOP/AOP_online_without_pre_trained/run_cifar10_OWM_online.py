...
# Load
print('Load data...')
data, taskcla, inputsize = dataloader.get2(seed=args.seed)
...
appr = approach.Appr(model=net, nepochs=args.nepochs,sbatch=10,num_class=num_class,lr=args.lr, args=args)
...
for t, ncla in taskcla:
    ...
    # Train
    appr.train(t, xtrain, ytrain, xvalid, yvalid, data,num_class=num_class,test_id=5)
    print('-'*100)
