...
class Appr(object):
    ...
    def __init__(self, model, nepochs=0, sbatch=64, lr=0,  clipgrad=1, args=None,num_class=10):
        self.model = model
        self.pre_h = None
        self.pre_x = None
        self.loss = None
    ...
    def train(self, t, xtrain, ytrain, xvalid, yvalid, data,num_class=10,test_id=5):
